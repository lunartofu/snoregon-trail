...
gameOverState.prototype = {
	init: function() {
		...
		this.titleText = game.add.text(game.world.centerX, 96, 'GAME OVER', utils.title_style);
	...
	create: function() {
		...
		this.button_retry = game.add.button(game.world.centerX, 600-96, 'button', this.start, this, 1, 2, 0);
